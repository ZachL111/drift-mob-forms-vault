"""Regression checks for the drift-mob-forms-vault casebook."""
...
from casebook.harness import assert_expected, drift_mob_forms_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_mob_forms_vault_summary(), assert_expected())
